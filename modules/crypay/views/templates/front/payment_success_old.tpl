<div class="box" style="background: #ffffff; border: 1px solid #e2e2e2; padding: 30px;">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12">
            ...
            <p>
                {l s='If you have any questions or need more information, please contact us at our' mod='crypay'}
                <strong class="dark"><a
                            href="{$link->getPageLink('contact-form', true)|escape:'html'}">{l s='customer support' mod='crypay'}</a>.</strong>
            </p>
